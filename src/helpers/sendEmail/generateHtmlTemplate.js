                                                                                                                            ...
                                                                                                                            <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                                                                ...
                                                                                                                                <div>
                                                                                                                                    <div
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            style="font-size: 43px">Thank you!&nbsp;</span>
                                                                                                                                    </div>
                                                                                                                                    <div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                                ...
                                                                                                                                <div>
                                                                                                                                    <div
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            ...
                                                                                                                                            Hello <b>${email}</b>, You are receiving this email because you are registering to <b> automated shisha kibondo system </b>!
                                                                                                                                        </span>
                                                                                                                                    </div>
                                                                                                                                    <div>
                                                                                                                                    </div>
...
export const generatePasswordHtmlTemplate = (link, { email, firstName, lastName, role }, password)=>{
                                                                                                                            ...
                                                                                                                            <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                                                ...
                                                                                                                                <div>
                                                                                                                                    <div
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            style="font-size: 18px">
                                                                                                                                            Hello <b>${firstName} ${lastName}</b>, You are receiving this email because you have got an account as <em><b>${role}</b></em> on <b> automated shisha kibondo system </b>!
                                                                                                                                            Use these credentials to log into your account:
                                                                                                                                            <pre>
                                                                                                                                                Email: ${email}
                                                                                                                                                Password: ${password}
                                                                                                                                            </pre>
